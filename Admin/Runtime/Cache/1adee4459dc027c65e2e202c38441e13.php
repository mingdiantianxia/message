...
$(function(){
	...
	$("#form-member-add").validate({//JQ认证框架
		rules:{
			username:{
				required:true,
				minlength:2,
...
if(<?php echo ($list['sex']); ?>==1){
	$('#sex-1').attr('checked', 'checked');//设置复选框属性值
}else{
